                ...
                <ul class="slides">
                    <li style="background-image:url(assets/img/tour.jpg)">
                        <div class="container text text-center">
                            ...
                            <p class="heading white">Minden túránkat a legjobb szakemberekkel egyeztetve szervezzük meg. Minden szombaton lehetőségetek adódik részt venni engedélyköteles vagy szabadon bejárható lelőhelyek közös felfedézésére.</p>
                        </div>
                ...
                <div class="container">
                    <div class="col-md-12 padding-leftright-null">
						<?php
									...
									$sql = "SELECT id, category, length, quantity, date, price, place, region, description FROM tours";
									$result = $conn->query($sql);

									if ($result->num_rows > 0) {
										echo "<table border='1'>";
										echo "<tr><th>ID</th><th>Kategória</th><th>Hossz/óra</th><th>Résztvevők/fő</th><th>Dátum</th><th>Ár/fő</th><th>Helyszín</th><th>Régió</th><th>Leírás</th><th>Módosítás</th></tr>";
										...
										while ($row = $result->fetch_assoc()) {
											...
											echo "<td><a href='edit_tour.php?id=" . $row['id'] . "'>Módosítás</a></td>";
											echo "</tr>";
										}
										echo "</table>";
									} else {
