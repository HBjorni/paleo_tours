        ...
        <header id="header" class="fixed transparent full-width">
                            ...
                            <ul>
								...
								<li>
                                    <?php
                                        ...
                                        if (isset($_COOKIE['id'])) {
                                            echo "<a href='profile.php' class='active-item'>$felhasznalo[username]</a>";
                                        }
                                        else {
		 ...
		 <div id="page-content" class="header-static footer-fixed">
            ...
            <div id="flexslider" class="fullpage-wrap small">
                <ul class="slides">
                    <li style="background-image:url(assets/img/me.jpg)">
                        <div class="container text text-center">
                            <h1 class="white margin-bottom-small">Profil</h1>
                        </div>
                        <div class="gradient dark"></div>
                    </li>
                    <ol class="breadcrumb">
                        <li><a href="#">Profil</a></li>
                        <li class="active">Saját</li>
                    </ol>
                </ul>
            </div>
                    ...
                    <div class="container">
                        <div class="col-md-6 padding-leftright-null">
                            <div data-responsive="parent-height" data-responsive-id="info" class="text padding-md-bottom-null">
                                <h2 class="margin-bottom-null title line left"><?= $felhasznalo['username']; ?></h2>
                                <div class="padding-onlytop-md">
                                    <p class="margin-bottom-null"><?= $felhasznalo['bio']; ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
