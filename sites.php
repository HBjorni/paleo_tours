...
<body>
                    ...
                    <div id="menu-classic">
                        <div class="menu-holder">
                            <ul>
								...
								<li><a href="sites.php" class="active-item">Lelőhelyek</a></li>
                                <li class="submenu">
    ...
    <div class="container">
        <div class="col-md-12 padding-leftright-null">
            ...
            $countQuery = "SELECT COUNT(*) as total FROM sites";
            ...
            $lekerdezes = "SELECT * FROM sites LIMIT $offset, $itemsPerPage";
            $talalt_lelohelyek = $conn->query($lekerdezes);
            ...
            <section id="showcase-treks" class="page" data-isotope="load-simple">
                <div class="masonry-items two-columns">
                    ...
                    while ($lelohely = $talalt_lelohelyek->fetch_assoc()) {
                        $gallery = json_decode($lelohely['gallery'], true);
                        $first_image = (!empty($gallery) && is_array($gallery)) ? $gallery[0] : "default.jpg";
						
                    ?>
                        <a href="site.php?id=<?= $lelohely['id']; ?>">
                                ...
                                <div class="showcase-trek">
                                    ...
                                    <div class="content text-center">
                                        <div class="row margin-leftright-null">
                                            <div class="meta">
                                                <h3><?= htmlspecialchars($lelohely['sitename']); ?></h3>
                                                <p><?= htmlspecialchars($lelohely['introduction']); ?></p>
                                                <a href="site.php?id=<?= $lelohely['id']; ?>" class="btn-alt small margin-null">Részletek</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xs-6">
                        <div class="nav-left">
                            <?php if ($currentPage > 1): ?>
                                <a href="?page=<?= $currentPage - 1; ?>" class="btn-alt small margin-null">
                                    <i class="icon ion-ios-arrow-left"></i><span>Előző</span>
                                </a>
                            <?php else: ?>
                                <a href="#" class="btn-alt small margin-null disabled">
                                    <i class="icon ion-ios-arrow-left"></i><span>Előző</span>
                                </a>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="col-xs-6">
                        <div class="nav-right">
                            <?php if ($currentPage < $totalPages): ?>
                                <a href="?page=<?= $currentPage + 1; ?>" class="btn-alt small margin-null">
                                    <span>Következő</span><i class="icon ion-ios-arrow-right"></i>
                                </a>
                            <?php else: ?>
                                <a href="#" class="btn-alt small margin-null disabled">
                                    <span>Következő</span><i class="icon ion-ios-arrow-right"></i>
