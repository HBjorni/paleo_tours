<?php
    ...
    if (isset($_POST["upload-post-btn"])) {
        ...
        if (!isset($_COOKIE['id'])) {
            ...
            $conn->query("INSERT INTO posts VALUES(id, $felhasznalo[id], '$_POST[postTitle]', '$_POST[postDesc]', '$_POST[postText]', 0, '$date')");
...
<head>
    ...
    <title>Új poszt - PaleoTours</title>
    ...
    <div id="main-wrap" class="full-width">
        ...
        <div id="page-content" class="header-static footer-fixed">
            ...
            <div id="flexslider" class="fullpage-wrap small">
                <ul class="slides">
                    <li style="background-image:url(assets/img/bg-01.png)">
                        <div class="container text text-center">
                            <h1 class="white margin-bottom-small">Új poszt</h1>
                ...
                <div class="row margin-leftright-null">
                    <div class="container text">
                        ...
                        <section class="contact-form">
                            <form id="contact-form" method="post" action="new_post.php">
                                <input type="text" name="postTitle" class="form-field" placeholder="Cím...">
                                <input type="text" name="postDesc" class="form-field" placeholder="Rövid leírás...">
                                <textarea class="form-field" name="postText" id="postText" rows="16" placeholder="Szövege..."></textarea>
                                <input type="submit" name="upload-post-btn" class="btn-alt" value="Posztolás">
                            </form>
                        </section>
