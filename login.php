<?php
    ...
    if (isset($_POST["login-btn"])) {
        ...
        if (mysqli_num_rows($talalt_felhasznalo) == 1) {
            ...
            echo "<script>alert('Ilyen név nem létezik!')</script>";
        }
    }
                    ...
                    <li style="background-image:url(assets/img/contact.jpg)">
                        <div class="container text text-center">
                            ...
                            <form method="post" action="login.php">
                                ...
                                <input name="login-btn" type="submit" value="Belépek"><br><br>
                                <label style="color: white;">Még nincsen fiókod? <a href="reg.php"> Regisztrálj!</a></label>
                            </form>
