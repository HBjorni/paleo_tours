        ...
        <div id="page-content" class="header-static footer-fixed">
            <div id="flexslider" class="fullpage-wrap small">
                <ul class="slides">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="index.php">Főoldal</a></li>
                        <li><a href="tours.php" class="active">Szervezett Túrák</a></li>
                    </ol>
                </ul>
            </div>
            <div id="page-wrap" class="content-section fullpage-wrap grey-background">
                    ...
                    <section id="showcase-treks" class="page" data-isotope="load-simple">
                        <div class="masonry-items two-columns">
                            <?php
								...
								$lekerdezes = "SELECT * FROM tours";
								$talalt_turak = $conn->query($lekerdezes);
								while($tura = $talalt_turak->fetch_assoc()){
									$gallery = json_decode($tura['image'], true);
									$first_image = (!empty($gallery) && is_array($gallery)) ? $gallery[0] : "default.jpg";
									
							?>
                            <a href="tour.php?id=<?= $tura['id']; ?>"><div class="item one-item trekking">
                                <div class="showcase-trek">
                                    <span class="read">
                                            <?= $tura['category'];?>
                                        </span>
                                    <img src="<?php echo 'img/' . htmlspecialchars($first_image); ?>" alt="">
                                    <div class="content text-center">
                                        <div class="row margin-leftright-null">
                                            ...
                                            <div class="category">
                                                <h3><?= $tura['price']?> Ft/fő</h3>
                                            </div>
                                            <div class="info">
                                                <div class="col-md-12 padding-leftright-null">
                                                    <h6 class="heading"><?= $tura['place']?></h6>
                                                    <p class="margin-null"><?= $tura['region']?></p>
													<a href="tour.php?id=<?= $tura['id']; ?>" class="btn-alt small margin-null">Részletek</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row margin-leftright-null color-background">
                    <div class="col-md-12 text text-center">
                        <h4 class="big white margin-bottom-small">Szeretnél más lelőhelyre is túrát szervezni?</h4>
