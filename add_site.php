<?php
	...
	if (isset($_POST['upload-btn'])) {
		...
		$stmt = $conn->prepare("INSERT INTO sites (sitename, introduction, description, gallery) VALUES (?, ?, ?, ?)");
		if (!$stmt) {
			die("Hiba az előkészített lekérdezésben: " . $conn->error);
		}
		$stmt->bind_param("ssss", $sitename, $introduction, $description, $gallery);
		...
		<div id="page-content" class="header-static footer-fixed">
            ...
            <div id="home-wrap" class="content-section fullpage-wrap row grey-background">
				<div class="text padding-onlybottom-sm padding-md-top-null">
					...
					<form id="contact-form" class="padding-onlytop-md padding-md-topbottom-null" action="add_site.php" method="post">
					<div class="row">
						<div class="col-md-12">
							<input class="form-field" name="name" id="name" type="text" placeholder="Név" required>
						</div>
						<div class="col-md-12">
							<input class="form-field" name="introduction" id="introduction" type="text" placeholder="Bevezető" required>
						</div>
						<div class="col-md-12">
							...
							<div class="col-md-12">
								<div class="submit-area padding-onlytop-sm">
									<button type="submit" class="btn-alt" name="upload-btn" value="Lelőhely feltöltése">Lelőhely feltöltése</button>
								</div>
							</div>
						</div>
					</form>
