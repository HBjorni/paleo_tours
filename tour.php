		...
		<div id="page-content" class="header-static footer-fixed">
			...
			<div id="home-wrap" class="content-section fullpage-wrap row grey-background">
                <div class="container">
					...
					<?php
							$lekerdezes = "SELECT * FROM tours WHERE id=$tourid ";
							$talalt_turak = $conn->query($lekerdezes);

							if ($talalt_turak->num_rows > 0) {
								while($tura = $talalt_turak->fetch_assoc()) {
									$tura_neve = ($tura['place']);
									$tura_leiras = ($tura['description']);
								}
							}
							
							echo "<div>";
							echo "<h1 class='text-center margin-bottom-small'>$tura_neve</h1>";
							echo "</div>";
							
							echo "<div class='text-center'>";
							echo "<p class='left-align'>$tura_leiras</p>";
							echo "</div>";
