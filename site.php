			...
			<div id="home-wrap" class="content-section fullpage-wrap row grey-background">
                <div class="container">
                    <div class="col-md-12 padding-leftright-null">
						...
						<?php
							$lekerdezes = "SELECT * FROM sites WHERE id=$siteid ";
							$talalt_lelohelyek = $conn->query($lekerdezes);

							$kepek = array();
							if ($talalt_lelohelyek->num_rows > 0) {
								while($lelohely = $talalt_lelohelyek->fetch_assoc()) {
									$lelohely_kepek = json_decode($lelohely['gallery']);
									$kepek = array_merge($kepek, $lelohely_kepek);
									$lelohely_neve = ($lelohely['sitename']);
									$lelohely_leiras = ($lelohely['description']);
								}
							}
							
							echo "<div>";
							echo "<h1 class='text-center margin-bottom-small'>$lelohely_neve</h1>";
							echo "</div>";
							
							echo "<div class='text-center'>";
							echo "<p class='left-align'>$lelohely_leiras</p>";
							echo "</div>";
							...
							foreach ($kepek as $index => $kep) {
								echo "<a href='img/$kep' class='lightbox gallerysajat'><img src='img/$kep' alt='$kep' style='width: 100%; height: 200px; object-fit: cover;'></a>";
						...
						<div class="col-md-12">
							<div class="details-section">
								...
								<?php
									$location = urlencode($lelohely_neve);
