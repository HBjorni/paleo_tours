<?php
	...
	if (isset($_POST['upload-btn'])) {
		...
		$stmt = $conn->prepare("INSERT INTO tours (category, length, quantity, date, price, place, region, description) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
		if (!$stmt) {
			die("Hiba az előkészített lekérdezésben: " . $conn->error);
		}
		$stmt->bind_param("ssssssss", $category, $length, $quantity, $date, $price, $place, $region, $description);
		...
		<div id="page-content" class="header-static footer-fixed">
			...
			<div id="home-wrap" class="content-section fullpage-wrap row grey-background">
				<div class="text padding-onlybottom-sm padding-md-top-null">
					...
					<form id="contact-form" class="padding-onlytop-md padding-md-topbottom-null" action="add_tour.php" method="post">
					<div class="row">
						<div class="col-md-12">
							<input class="form-field" name="category" id="category" type="text" placeholder="Kategória" required>
						</div>
						<div class="col-md-12">
							<input class="form-field" name="length" id="length" type="text" placeholder="Hossz/óra" required>
						</div>
						<div class="col-md-12">
							<input class="form-field" name="quantity" id="quantity" type="text" placeholder="Résztvevők/fő" required>
						</div>
						<div class="col-md-12">
							<input class="form-field" name="date" id="date" type="date" required>
						</div>
						<div class="col-md-12">
							<input class="form-field" name="price" id="price" type="text" placeholder="Ár/fő" required>
						</div>
						<div class="col-md-12">
							<input class="form-field" name="place" id="place" type="text" placeholder="Helyszín" required>
						</div>
						<div class="col-md-12">
							<input class="form-field" name="region" id="region" type="text" placeholder="Régió" required>
						</div>
						<div class="col-md-12">
							<input class="form-field" name="description" id="description" type="text" placeholder="Leírás" required>
						</div>
							<div class="col-md-12">
								<div class="submit-area padding-onlytop-sm">
									<button type="submit" class="btn-alt" name="upload-btn" value="Túra feltöltése">Túra feltöltése</button>
								</div>
							</div>
						</div>
					</form>
                        ...
                        <div class="row no-margin">
                            ...
                            <div class="col-sm-4 col-md-2 padding-leftright-null">
                                ...
                                <ul class="useful-links">
									<li><a href="forum.php">Fórum</a></li>
                                    <li><a href="tours.php">Szervezett túrák</a></li>
									<li><a href="faq.php">FAQ</a></li>
